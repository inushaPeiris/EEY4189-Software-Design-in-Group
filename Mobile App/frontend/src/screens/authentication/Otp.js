    ...
    return (
        <SafeAreaView>
            <ScrollView>
                ...
                {/* Text Input Fields */}
                <View style={style.formInput}>
                    <TextInput style={style.textInput} placeholder="OTP"/>
                </View>

                {/* Main Button */}
                <View style={style.formInput}>
                    <TouchableOpacity style={style.mainButton}>
                        <Text style={{ textAlign: 'center', fontSize: 16, fontWeight: '500', color: 'white' }} onPress={()=> navigation.navigate("Resetpw")}>
                            Submit
                        </Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={style.backRoute}>
                    <TouchableOpacity>
                        <Text style={{ color: '#076ff7', fontSize: 16, fontWeight: '500', textAlign: 'center' }} onPress={()=> navigation.navigate("Forgotpw")}>
                            Back
                        </Text>
                    </TouchableOpacity>
                </View>
