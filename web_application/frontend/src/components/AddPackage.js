...
export default class AddPackage extends Component {
  ...
  handleAddPackage = async (e) => {
    ...
    try {
        ...
        data.append('placesToVisit', placesToVisit); // Assuming placesToVisit is a comma-separated string
          ...
          <Row className="align-items-center justify-content-between">
            ...
            <Col xs={8} md={10}>
              ...
              <Form>
                ...
                <Button variant="primary" className="button" onClick={this.handleAddPackage} style={{backgroundColor: 'rgb(0, 0, 72)'}}>
                  Add New Package
                </Button>
              </Form>
            </Col>
